...
5. Rebuild: `cd container && ./build.sh && cd .. && npm run build && launchctl kickstart -k gui/$(id -u)/com.nanoclaw.yinyue` (macOS) or `systemctl --user restart nanoclaw` (Linux)
...
8. Rebuild: `cd container && ./build.sh && cd .. && npm run build && launchctl kickstart -k gui/$(id -u)/com.nanoclaw.yinyue` (macOS) or `systemctl --user restart nanoclaw` (Linux)
